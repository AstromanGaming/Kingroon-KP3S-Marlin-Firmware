...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_NAME_4 "Back-Left (Default)"
...
#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  43.3        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  28.5        // (Hz) The default dominant resonant frequency on the Y axis.
 ...
 */
#define STARTUP_COMMANDS "M117 Warning: No Password!"
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "Nozzle Clean"
  #define MAIN_MENU_ITEM_1_GCODE "G12"
  #define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "Nozzle Park"
  #define MAIN_MENU_ITEM_2_GCODE "G27"
  #define MAIN_MENU_ITEM_2_CONFIRM

  //#define MAIN_MENU_ITEM_3_DESC "Home/Level/Home (Cura)"
...
#define CUSTOM_MENU_CONFIG
  ...
  #define CONFIG_MENU_ITEM_1_DESC "Touch Screen Calibration"
 ...
 */
  ...
  // Options pertaining to MMU2 and MMU2S
    ...
    //#define MMU2_FILAMENTCHANGE_EJECT_FEED 80

    // G-code to execute when MMU2 F.I.N.D.A. probe detects filament runout
    //#define MMU2_FILAMENT_RUNOUT_SCRIPT "M600"

    // MMU2 sequences use mm/min. Not compatible with MMU3, which use mm/sec.
    //#define MMU2_LOAD_TO_NOZZLE_SEQUENCE {  4.4,  871 }, { 10.0, 1393 }, {  4.4,  871 }, { 10.0,  198 }
      {  4.4,  871 }, \
      { 10.0, 1393 }, \
      {  4.4,  871 }, \
      { 10.0,  198 }
   ...
   */
    ...
    //#define MMU2_CAN_LOAD_RETRACT   6   // (mm) Keep under the distance between Load Sequence values
