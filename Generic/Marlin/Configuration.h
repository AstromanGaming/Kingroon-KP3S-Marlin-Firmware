...
*/
#define X_PROBE_OFFSET 25 // GR valori del mio fan holder
#define Y_PROBE_OFFSET 0  // GR valori del mio fan holder
#define Z_PROBE_OFFSET -2.6  // GR valori del mio fan holder
